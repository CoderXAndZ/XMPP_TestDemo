...
@interface XZEmoticonManager : NSObject
...
///
/// @return 表情模型
- (XZEmoticon * _Nullable)emoticonWithString:(NSString * _Nonnull)string;

/// 表情包数组
@property (nonatomic, nonnull) NSMutableArray <XZEmoticonPackage *>*packages;
...
///
/// @param emoticon 表情模型
- (void)addRecentEmoticon:(XZEmoticon * _Nonnull)emoticon;
