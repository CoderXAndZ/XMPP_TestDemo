...
- (NSString *)emoticonText {
    ...
    [attributeText
     ...
     usingBlock:^(NSDictionary<NSString *,id> * _Nonnull attrs, NSRange range, BOOL * _Nonnull stop) {
         ...
         XZEmoticonAttachment *attachment = attrs[@"NSAttachment"];
         if (attachment != nil) {
...
- (void)insertEmoticon:(XZEmoticon *)emoticon isRemoved:(BOOL)isRemoved {
    ...
    NSAttributedString *emoticonStr = [XZEmoticonAttachment emoticonStringWithEmoticon:emoticon font:self.font textColor:self.textColor];
...
- (void)prepareInputView {
    ...
    _emoticonInputView = [[XZEmoticonInputView alloc] initWithSelectedEmoticon:^(XZEmoticon * _Nullable emoticon, BOOL isRemoved) {
